...
print('bert-base')
print('noun', w.count('noun')/360)

print('correct', w.count('target')/360)
print('random', w.count('random')/360)
...
model = BertModel.from_pretrained("FacebookAI/roberta-base")
correct = 0
hard = 0
random = 0
guess = []
...
# model = AutoModel.from_pretrained("huggyllama/llama-65b")
# correct = 0
# hard = 0
# random = 0
# guess = []
